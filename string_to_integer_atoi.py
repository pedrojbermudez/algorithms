"""
    ...
    Example 3:
        ...
        Explanation:
            ...
            Since 4193 is in the range [-2**31, 2**31 - 1], the final result is 
            4193.
"""
        ...
        for c in s:
            if not is_valid_char:
                if c == '+':
                    ...
                    is_valid_char = True
                    sign = -1
                elif not c == ' ' and c not in digits:
                    break
                elif  c == ' ':
                    pass
                elif c in digits:
                    is_valid_char = True
                    output = output * 10 + (ord(c) - 48)
            else:
                if not c in digits:
                    break
                else:
...
def main():
    ...
    n4 = sol.myAtoi('         -42')
    n5 = sol.myAtoi('e         -42')
    n6 = sol.myAtoi("-2147483649")
    n7 = sol.myAtoi("   +0 123")
    n8 = sol.myAtoi("123 words")
    print(n1)
    print(n2)
    print(n3)
    print(n4)
